...
export default function QnaDetail() {
  ...
  //           event handler               //
  const onCommentChagneHandler = (event: ChangeEvent<HTMLTextAreaElement>) => {
        ...
        <div id='qna-detail-wrapper'>
            ...
            <div className='qna-detail-comment-write-box'>
                <div className='qna-detail-comment-textarea-box'>
                    <textarea ref={commentRef} className='qna-detail-comment-textarea' placeholder='답글을 작성해주세요.' value={comment == null ? '' : comment} 
                    onChange={onCommentChagneHandler} />
                </div>
